...
public class UserControllerTest {
    ...
    public void join_test() throws Exception {
        // given
        String requestBody = "username=피카츄&password=1111&email=asd@nate.com";
    ...
    public void login_test() throws Exception {
        // given
        String requestBody = "username=피카츄&password=1111";
        ...
        // then
        assertThat(principal.getUsername()).isEqualTo("피카츄");
        resultActions.andExpect(status().is3xxRedirection());
    }
}
